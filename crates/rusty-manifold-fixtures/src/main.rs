...
struct FixtureSet {
    ...
    remove_active_transport_stream_registry_request: ManifoldStreamRegistryChangeRequest,
    remove_active_transport_stream_registry_review: ManifoldStreamRegistryAuthorityReview,
    disable_active_ui_stream_registry_request: ManifoldStreamRegistryChangeRequest,
    disable_active_ui_stream_registry_review: ManifoldStreamRegistryAuthorityReview,
    lower_active_subscriber_limit_stream_registry_request: ManifoldStreamRegistryChangeRequest,
    lower_active_subscriber_limit_stream_registry_review: ManifoldStreamRegistryAuthorityReview,
