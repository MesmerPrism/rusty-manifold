...
fn peer_entries() -> Vec<SchemaEntry> {
    vec![
        entry(
            "rusty.manifold.media.route_leg_descriptor.v1",
            "ManifoldMediaRouteLegDescriptor",
            &[],
        ),
        entry(
        ...
        entry(
            ...
            "ManifoldCommonLanReciprocalEd25519Receipt",
            &[],
        ),
        entry(
            "rusty.manifold.peer.session_state.v2",
            "ManifoldPeerSessionAuthorityStateV2",
            &[],
        ),
        entry(
            "rusty.manifold.peer.common_lan_session_proposal.v1",
            "ManifoldCommonLanPeerSessionProposal",
            &[],
        ),
        entry(
        ...
        entry(
            ...
            "ManifoldPairMediaRouteTerminationRequestV2",
            &[],
        ),
        entry(
        ...
        entry(
            ...
            "ManifoldPairMediaRouteCleanupCompletionRequestV2",
            &[],
        ),
        entry(
        ...
        entry(
            "rusty.manifold.peer.pair_media_route_state.v1",
            "ManifoldPairMediaRouteState",
            &[],
        ),
        entry(
            "rusty.manifold.peer.pair_media_route_request.v1",
            "ManifoldPairMediaRouteRequest",
            &[],
        ),
        entry(
            "rusty.manifold.peer.pair_media_route_record.v1",
            "ManifoldAcceptedPairMediaRoute",
            &[],
        ),
        entry(
            "rusty.manifold.peer.pair_media_route_receipt.v1",
            "ManifoldPairMediaRouteReceipt",
            &[],
        ),
        entry(
            "rusty.manifold.peer.pair_media_route_termination_request.v1",
            "ManifoldPairMediaRouteTerminationRequest",
            &[],
        ),
        entry(
